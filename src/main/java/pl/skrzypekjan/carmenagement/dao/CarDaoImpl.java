...
public class CarDaoImpl implements CarDao{
    ...
    @Override
    public void addCar(long id, String mark, String model, Color color, int prodYear) {
    ...
    public List<Car> findAll() {
        ...
        maps.stream().forEach(element -> carList.add(new Car(
                ...
                Color.valueOf(( String ) element.get("color")),
    ...
    public List<Car> findByProductionYear(int min, int max) {
        ...
        String sql = "SELECT * FROM cars WHERE cars.production_year > ? & cars.production_year < ?";
